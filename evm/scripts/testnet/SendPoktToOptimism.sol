...
contract SendPoktToOptimism is Script, WormholeChainIds {
    ...
    function run() public {
        ...
        ).allTrustedSenders(optimismSepoliaWormholeChainId);
        ...
        uint256 bridgeCostValue = WormholeBridgeAdapter(wormholeBridgeAdapter)
            .bridgeCost(optimismSepoliaWormholeChainId);
        ...
        }(optimismSepoliaWormholeChainId, 1e6, poktHolder);
