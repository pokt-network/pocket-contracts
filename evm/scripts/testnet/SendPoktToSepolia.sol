...
contract SendPoktToSepolia is Script, WormholeChainIds {
    ...
    function run() public {
        ...
        ).allTrustedSenders(sepoliaWormholeChainIds);
        ...
        uint256 bridgeCostValue = WormholeBridgeAdapter(wormholeBridgeAdapter)
            .bridgeCost(sepoliaWormholeChainId);
        ...
        }(sepoliaWormholeChainId, 1e5, poktHolder);
